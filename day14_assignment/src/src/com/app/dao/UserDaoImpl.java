...
public class UserDaoImpl implements UserDao {
	...
	public String SetUpdatePassword(String newPassword,String email,String Password  ) throws SQLException{
		...
		if (row==1)
			return "pasword change";
		return "changing password faild";
	
	}
	
	public String deleteEmail(String email) throws SQLException{
