...
//add a method for user's signin
	...
	//add a meth0de to update password
	String SetUpdatePassword(String email,String password,String newPassword  )
	 throws SQLException;
	String deleteEmail(String email) throws SQLException;
